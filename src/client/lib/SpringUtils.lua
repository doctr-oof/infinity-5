...
function SpringUtils.IsAnimating(spring, epsilon)
...
function SpringUtils.WaitForCompletion(spring, margin)
    while math.abs(spring.p - spring.t) > (margin and margin or EPSILON) do wait() end
end
